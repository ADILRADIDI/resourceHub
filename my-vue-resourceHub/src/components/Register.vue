<template>
  <div id="container" class="flex h-screen">
    ...
    <!-- Right Side (Form) -->
    <div id="partieRight" class="flex flex-col justify-center items-center w-full md:w-1/2 p-8 bg-white">
      ...
      <h1 class="text-4xl mt-3 font-bold mb-20">Create Your Account</h1>
      ...
      <form @submit.prevent="register" class="w-full max-w-sm">
        ...
        <div class="mb-6">
          <label for="confirm-password" class="block text-sm font-bold text-gray-700">Confirm Password</label>
          <input v-model="confirmPassword" type="password" id="confirmation-password" placeholder="Confirm Password" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-[#EDF2F4] focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
