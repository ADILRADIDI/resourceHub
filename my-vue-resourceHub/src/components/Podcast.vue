<template>
    <div class="min-h-screen bg-gradient-to-b from-blue-500 to-blue-700 flex flex-col items-center p-8">
      ...
      <header class="text-center mb-8">
        ...
        <p class="text-white mt-2">Latest episodes from your favorite shows</p>
      </header>
  ...
  export default {
    data() {
      return {
        ...
        //   src="https://dts.podtrac.com/redirect.mp3/traffic.megaphone.fm/FOR6494492862.mp3?updated=1656502985"
          {
            title: 'Learning AI 1',
            creator: 'Matt Eland',
    ...
    methods: {
      playPodcast(podcast) {
        if (this.currentPodcast && this.currentPodcast !== podcast) {
          this.audio.pause();
        ...
        this.audio.src = podcast.audioSrc;
        this.audio.play();
        this.isPlaying = true;
        this.updateProgress();
      },
  ...
  <style scoped>
  /* Ensures podcast cards have a minimum width */
  .relative {
    min-width: 200px;
  }
  </style>
